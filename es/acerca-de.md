...
story-3: 
  - image_path: /assets/images/about_story-3.jpeg
    ...
    title: "De los datos al diálogo en el escenario"
    excerpt: 'En el <strong>Primer Congreso para Occidente "Fortalecemos la Salud Materna y Neonatal en Occidente"</strong>, el valor de la ciencia no se quedó en los reportes; se encontró en su capacidad de ser discutida. Esta experiencia me dio la oportunidad de traducir <strong>información compleja en una conversación práctica y con propósito</strong>, algo que considero fundamental para el éxito de cualquier iniciativa de salud.<br><br>Me demostró que el conocimiento científico es más valioso cuando se convierte en una historia que tiene el poder de resonar en la gente y de influir en la toma de decisiones.'
books:
  - title: "La curiosidad que me define"
  - excerpt: "Mi trabajo se nutre de la curiosidad y de la multidisciplinariedad. Estas obras me han ayudado a entender la complejidad de la medicina, la economía y la psicología humana, habilidades que considero cruciales para cualquier persona que busca generar un impacto real y duradero."
---
<style>
.feature-divider {
  margin-top: 4rem;
...
<div class="about-values">
    <h1>Valores que reflejan mi enfoque personal y profesional</h1>
    <h2>Fuerza en la unidad: Multiplicando logros en equipo</h2>
    <p>El potencial de sinergia que se genera al unir esfuerzos es invaluable. Creo en la diversidad de opiniones y habilidades, y sé que al colaborar con otros, podemos superar cualquier obstáculo y lograr resultados excepcionales.</p>
    <h2>El ego es una barrera para el crecimiento</h2>
    <p>Para mí, el ego representa un obstáculo clave para el crecimiento personal y profesional. Al practicar la humildad y mantenernos abiertos a la retroalimentación y el aprendizaje, podemos superar nuestras limitaciones autoimpuestas y alcanzar nuevas alturas en nuestra trayectoria.</p>
